...
// Reads from employees-data.js (GitHub file)
// Falls back to localStorage (local testing)
...
function getAllEmployees() {
  // PRIMARY: Read from employees-data.js (served from Vercel/GitHub)
  if (window.MRK_EMPLOYEES && window.MRK_EMPLOYEES.length > 0) {
    return window.MRK_EMPLOYEES;
  }
  // FALLBACK: Local testing via localStorage
  try {
